...
export default class CreateDeliveryLog extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('http://18.206.173.78:4000/deliveries/getLog', delivery)
  ...
  render() {
    ...
    <div   >
      <h3 style={{color: 'black', marginLeft:'auto', width: '50%', fontSize: '2.5rem', marginRight:'2rem'}}>Create New Delivery Log</h3>
      <form onSubmit={this.onSubmit}>
        <div className="form-group"> 
          <label style={{color:'black', fontSize:'1.5rem'}}>Enter Robotname: </label>
    ...
    <br/>
    <div className='form-group'>
    <h3 style={{color:'black', fontSize:'2rem'}}>Deliveries:</h3>
        <table className="table">
          <thead className="thead-light">
            <tr style={{color:'coral', fontSize:'1.5rem'}}>
              <th>Robotname</th>
              <th>Date</th>
              <th>Status</th>
            </tr>
